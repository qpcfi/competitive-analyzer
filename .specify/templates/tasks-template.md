...
Contract tests are REQUIRED for new or changed API endpoints and SSE payloads.
Integration tests are REQUIRED for state transitions, checkpoint resume, partial
rerun, L1/L2 quality gates, evidence propagation, and security/privacy controls.
...
- [ ] T010 Configure traceable logging, SSE event schema, and reconnect buffers
- [ ] T011 Configure robots/access-policy checks and PII redaction utilities
...
- [ ] T014 [P] [US1] Traceability/quality-gate test for [schema/evidence/state behavior] in tests/integration/test_[name].py
...
- [ ] T019 [US1] Add L1 validation, L2 feedback handling, and bounded retry/degrade behavior
- [ ] T020 [US1] Add telemetry, SSE events, and debug raw-data access for this story
...
- [ ] T023 [P] [US2] Compliance/security test for [auth, ownership, robots, or PII behavior] in tests/integration/test_[name].py
...
- [ ] T030 [P] [US3] Frontend responsive or workflow test for [view/state] in frontend/tests/[name].spec.ts
